    ...
    <footer className="ml-58 border-t border-black/6 dark:border-white/6 bg-white/96 dark:bg-zinc-900/96 px-8 py-6 flex items-center justify-between gap-6 flex-wrap transition-colors">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="text-xs font-[family-name:var(--font-roboto-mono)] text-zinc-400 uppercase tracking-widest mt-0.5">Meta Ads Analytics · V8.0</div>
        </div>
      ...
      <div className="flex flex-col items-end gap-1">
        <span className="text-[11px] font-[family-name:var(--font-roboto-mono)] text-zinc-400 uppercase tracking-widest">Proyecta Intelligence · V8.0 · 2026</span>
