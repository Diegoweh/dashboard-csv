import { DashboardData, Industry, IndustryBenchmark } from './types';
...
export const INDUSTRY_BENCHMARKS: Record<Industry, IndustryBenchmark> = {
  'Atracción / Entretenimiento': { scale: 4, stable: 7, optimize: 12, pause: 12, ctrMin: 2.0, freqAlert: 2.5, lpvMin: 85, cpmAlert: 80 },
  'Hotel / Hospedaje':           { scale: 8, stable: 12, optimize: 18, pause: 18, ctrMin: 1.8, freqAlert: 3.0, lpvMin: 80, cpmAlert: 100 },
  'Turismo / Atracción':         { scale: 5, stable: 8, optimize: 14, pause: 14, ctrMin: 2.0, freqAlert: 2.5, lpvMin: 85, cpmAlert: 80 },
  'Food & Lifestyle':            { scale: 3, stable: 6, optimize: 10, pause: 10, ctrMin: 2.5, freqAlert: 2.5, lpvMin: 85, cpmAlert: 60 },
  'Healthcare / Salud':          { scale: 10, stable: 18, optimize: 30, pause: 30, ctrMin: 1.5, freqAlert: 3.0, lpvMin: 80, cpmAlert: 120 },
  'Ecommerce':                   { scale: 5, stable: 8, optimize: 14, pause: 14, ctrMin: 2.0, freqAlert: 2.5, lpvMin: 85, cpmAlert: 70 },
  'Bienes Raíces':               { scale: 15, stable: 25, optimize: 45, pause: 45, ctrMin: 1.2, freqAlert: 3.5, lpvMin: 75, cpmAlert: 150 },
  'B2B / Servicios':             { scale: 12, stable: 20, optimize: 35, pause: 35, ctrMin: 1.5, freqAlert: 3.0, lpvMin: 80, cpmAlert: 100 },
  'Retail / Comercio':           { scale: 4, stable: 7, optimize: 12, pause: 12, ctrMin: 2.0, freqAlert: 2.5, lpvMin: 85, cpmAlert: 70 },
  'Otro':                        { scale: 5, stable: 8, optimize: 14, pause: 14, ctrMin: 2.0, freqAlert: 2.5, lpvMin: 85, cpmAlert: 80 },
};
...
export const DEMO_DATA: DashboardData = {
  ...
  campaigns: [
    { name: 'Prosp_Familias_Video',     spend: 820, cpc: 1.60, cpli: 3.10, ctr: 3.1, lpv: 512, freq: 1.6, intent: 179, action: 'Escalar',    cpm: null, impressions: null, reach: null, link_clicks: null },
    { name: 'Retarg_Visita_Producto',   spend: 210, cpc: 1.05, cpli: 1.80, ctr: 4.2, lpv: 200, freq: 2.9, intent: 70,  action: 'Optimizar',  cpm: null, impressions: null, reach: null, link_clicks: null },
    { name: 'Prosp_Broad_Carousel',     spend: 640, cpc: 2.80, cpli: 5.40, ctr: 2.4, lpv: 229, freq: 1.9, intent: 80,  action: 'Estable',    cpm: null, impressions: null, reach: null, link_clicks: null },
    { name: 'LAL_1pct_Compradores',     spend: 590, cpc: 3.10, cpli: 6.20, ctr: 2.1, lpv: 190, freq: 2.0, intent: 67,  action: 'Optimizar',  cpm: null, impressions: null, reach: null, link_clicks: null },
    { name: 'Prosp_Broad_Static_Image', spend: 480, cpc: 4.80, cpli: 9.60, ctr: 1.1, lpv: 100, freq: 4.1, intent: 35,  action: 'Pausar HOY', cpm: null, impressions: null, reach: null, link_clicks: null },
    { name: 'Retarg_Homepage',          spend: 460, cpc: 2.30, cpli: 7.10, ctr: 2.6, lpv: 200, freq: 3.8, intent: 70,  action: 'Optimizar',  cpm: null, impressions: null, reach: null, link_clicks: null },
  ],
};
...
export function saveDashboardInsights(data: DashboardData): void {
  ...
  const bestCamp = [...campaigns].sort((a, b) => (a.cpli ?? 999) - (b.cpli ?? 999))[0];
